...
<table border="0" cellpadding="8" cellspacing="0">
  <tr>
    <th align="left">My main key strengths</th>
    <th align="left">In my free time, I like:</th>
    <th align="left">My Mottoes:</th>
  </tr>
  <tr>
    <td valign="top">
      <ul><li>Patience</li><li>Punctuality</li><li>Discipline</li><li>Determination</li><li>Ambition</li><li>Curiosity</li><li>Altruism</li></ul>
    </td>
    <td valign="top">
...
## Check out my [<ins>🎓IT certifications</ins>](https://andreadevita99.github.io/IT-Certificates-Portfolio/) & my [<ins>🗂Database Hub</ins>](https://andreadevita99.github.io/Database-Hub/) !

**🗣Spoken languages**:
| Languages | CEFR Level |
|--|--|
| 🇮🇹Italian | C2 *(Native)* |
| 🇬🇧English | C1 *(Advanced / Proficient)* |
| 🇪🇸Spanish | A1 *(Beginner)* |
| 🇫🇷French  | A1 *(Beginner)* |
